...
def parse_query(raw: str) -> ParsedQuery:
    ...
    limit, text_without_limit = _extract_limit(text_without_time)
    source, text_without_source = _extract_source(text_without_limit)
    category, text_without_category = _extract_category(text_without_source)
    search_text = re.sub(r"\s+", " ", text_without_category).strip()
    return ParsedQuery(
