...
from radar.common.quality_checks import run_all_checks  # noqa: E402
...
from radar.relevance import apply_source_context_entities, filter_relevant_articles  # noqa: E402
...
def main() -> None:
    ...
    print(f"actionable_game_event_count={summary['actionable_game_event_count']}")
