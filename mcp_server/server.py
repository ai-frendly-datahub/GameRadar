...
def _list_tool_specs() -> list[dict[str, object]]:
    return [
        {
            "name": "search",
            "description": "Search gaming news and releases.",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "query": {"type": "string"},
        ...
        {
            "name": "recent_updates",
            "description": "List recently collected gaming articles from DuckDB.",
            "inputSchema": {
                "type": "object",
                "properties": {
        ...
        {
            "name": "top_trends",
            "description": "Show top entity frequencies from recent gaming article matches.",
            "inputSchema": {
                "type": "object",
                "properties": {
                    "days": {"type": "integer", "minimum": 1},
